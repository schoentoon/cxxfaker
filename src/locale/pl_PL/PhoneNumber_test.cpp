...
#include "locale/pl_PL/PhoneNumber.h"
...
class pl_PL_PhoneNumber : public ::tests::Base {
};
...
TEST_F(pl_PL_PhoneNumber, Operator) {
  cxxfaker::providers::pl_PL::PhoneNumber phonenumber;
  phonenumber.Seed(::testing::UnitTest::GetInstance()->random_seed());
