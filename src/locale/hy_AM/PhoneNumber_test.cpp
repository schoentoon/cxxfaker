...
class hy_AM_PhoneNumber : public ::tests::Base {
};

TEST_F(hy_AM_PhoneNumber, PhoneNumber) {
  cxxfaker::providers::hy_AM::PhoneNumber* phonenumber = new cxxfaker::providers::hy_AM::PhoneNumber();
...
TEST_F(hy_AM_PhoneNumber, Operator) {
  cxxfaker::providers::hy_AM::PhoneNumber phonenumber;
  phonenumber.Seed(::testing::UnitTest::GetInstance()->random_seed());
