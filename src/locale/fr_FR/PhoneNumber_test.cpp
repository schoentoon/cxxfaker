...
class fr_FR_PhoneNumber : public ::tests::Base {
};

TEST_F(fr_FR_PhoneNumber, PhoneNumber) {
  cxxfaker::providers::fr_FR::PhoneNumber* phonenumber = new cxxfaker::providers::fr_FR::PhoneNumber();
...
TEST_F(fr_FR_PhoneNumber, Operator) {
  cxxfaker::providers::fr_FR::PhoneNumber phonenumber;
  phonenumber.Seed(::testing::UnitTest::GetInstance()->random_seed());
